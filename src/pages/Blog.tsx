        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {filteredArticles.map((article, idx) => {
              // Safety check to ensure we use a raw string and not a Sanity object for the slug link
              const safeSlug = (article as any).slug?.current || article.slug;
              ...
              return (
                ...
                >
                  <Link to={`/insights/${safeSlug}`} className="block aspect-16/10 overflow-hidden">
                    <img 
                  ...
                  <div className="p-8 grow flex flex-col">
                    ...
                    <h2 className="text-2xl font-bold mb-4 leading-tight group-hover:text-brand-primary transition-colors">
                      <Link to={`/insights/${safeSlug}`}>{article.title}</Link>
                    </h2>
                    ...
                    <div className="mt-auto pt-6 border-t border-border flex items-center justify-between">
                      ...
                      <Link to={`/insights/${safeSlug}`} className="text-brand-primary text-sm font-bold flex items-center gap-2 group/link">
